...
\begin{itemize}
	...
	\item \textbf{Industrial Inspection:} Tasks such as defect detection, product sorting, and surface analysis depend on precise region separation. Segmentation makes automated inspection more reliable.
	\item \textbf{Digital Photography:} Image editing, background removal, blur control, and compositing all rely on clean boundaries between objects. Segmentation enables fast and high quality processing.
