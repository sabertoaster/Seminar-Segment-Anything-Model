...
\begin{itemize}
    \item Original image is processed at full resolution (1024 pixels shortest side after downsampling).
...
Standard ViT processes images at fixed resolution (e.g., $224 \times 224$), but SAM's images are high-resolution (1024 pixels shortest side). SAM uses a modified ViT-H that:
...
\textbf{Output:} For a $1024 \times 1024$ image with $16 \times 16$ patches, the image embedding has shape $(64 \times 64, 768)$—a $64 \times 64$ spatial grid of 768-dimensional feature vectors. After transformer block and 2 layers of convolution, the final embedding has shape $(64 \times 64, 256)$.
